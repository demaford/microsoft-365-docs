...
Microsoft Entra ID doesn't solve for lack of governance in your identity world! [Identity governance](/azure/active-directory/governance/identity-governance-overview) should be a critical element independent of any cloud decisions. Governance requirements change over time, which is why it's a program and not a tool.
...
![Policy engine in Microsoft Entra ID.](../media/solutions-architecture-center/identity-and-beyond-illustration-3.png)
...
<a name='azure-ad-and-microsoft-365-admin-centers'></a>
